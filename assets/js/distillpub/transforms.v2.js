...
function _defineProperty3(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('fs')) : typeof define === 'function' && define.amd ? define(['exports', 'fs'], factory) : (global = global || self, factory(global.dl = {}, global.fs));
})(void 0, function (exports, fs) {
  'use strict';

  fs = fs && Object.prototype.hasOwnProperty.call(fs, 'default') ? fs['default'] : fs; // Copyright 2018 The Distill Template Authors
  //
  ...
  var objectFromMap = function objectFromMap(map) {
    var object = Array.from(map).reduce(function (object, _ref) {
      var _ref2 = _slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];
      return Object.assign(object, _defineProperty3({}, key, value));
  ...
  function _moveLegacyAffiliationFormatIntoArray(frontMatter) {
    ...
    var _iterator = _createForOfIteratorHelper(frontMatter.authors),
      _step;
    try {
  ...
  var bibtexParse = createCommonjsModule(function (module, exports) {
    /* start bibtexParse 0.0.22 */ //Original work by Henrik Muehe (c) 2010
    //
  ...
  function parseBibtex(bibtex) {
    ...
    var _iterator2 = _createForOfIteratorHelper(parsedEntries),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var entry = _step2.value;
        // normalize tags; note entryTags is an object, not Map
        for (var _i7 = 0, _Object$entries = Object.entries(entry.entryTags); _i7 < _Object$entries.length; _i7++) {
          var _Object$entries$_i = _slicedToArray(_Object$entries[_i7], 2),
            key = _Object$entries$_i[0],
            value = _Object$entries$_i[1];
          entry.entryTags[key.toLowerCase()] = normalizeTag(value);
        }
        entry.entryTags.type = entry.entryType; // add to bibliography
  ...
  function ExtractBibliography(dom, data) {
    ...
    if (src) {
      ...
      scriptTag.textContent = JSON.stringify(_toConsumableArray(bibliography));
  ...
  function collect_citations() {
    ...
    var _iterator3 = _createForOfIteratorHelper(citeTags),
      _step3;
    try {
  ...
  function bibliography_cite(ent, fancy) {
    if (ent) {
      ...
      cite += doi_string(ent);
      return cite; /*var cite =  author_string(ent, "${L}, ${I}", ", ", " and ");
                   if (ent.year || ent.date){
                   cite += ", " + (ent.year || ent.date) + ". "
                   } else {
                   cite += ". "
  ...
  function ExtractCitations(dom, data) {
    ...
    var _iterator5 = _createForOfIteratorHelper(newCitations),
      _step5;
    try {
      for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
        var citation = _step5.value;
  ...
  // limitations under the License.
  function HTML(dom) {
    var head = dom.querySelector('head'); // set language to 'en'
  ...
  function OptionalComponents(dom, data) {
    var body = dom.body;
    var article = body.querySelector('d-article'); // If we don't have an article tag, something weird is going on—giving up.
    if (!article) {
    ...
    (function (f) {
      ...
      return function e(t, n, r) {
        ...
        25: [function (require, module, exports) {
          /* eslint-disable no-unused-vars */var hasOwnProperty = Object.prototype.hasOwnProperty;
              ...
              value: function nextToken() {
                for (;;) {
                  ...
                  if (expansion.numArgs) {
                    var args = [];
                    var i = void 0; // obtain arguments, either single token or balanced {…} group
        ...
        33: [function (require, module, exports) {
          ...
          var _text = [D, Dc, T, Tc, T, Tc, T, Tc]; // We only export some of the styles. Also, we don't export the `Style` class so
        ...
        35: [function (require, module, exports) {
          ...
          var buildExpression = function buildExpression(expression, options, isRealGroup) {
            ...
            for (var _i3 = 0; _i3 < groups.length; _i3++) {
              if (groups[_i3].value === "\u0338" && _i3 + 1 < groups.length) {
                ...
                var container = (0, _buildCommon.makeSpan)(classes, children); // LaTeX adds a space between ords separated by a \\not.
          ...
          groupTypes.mod = function (group, options) {
            ...
            if (group.value.modType !== "pod") {
              ...
              if (group.value.modType === "bmod") {
                inner.push((0, _buildCommon.makeSpan)(["mbin"], modInner, options)); // “\mkern5mu\nonscript\mskip-\medmuskip”
                inner.push((0, _buildCommon.makeSpan)(["mspace", "thickspace"], [], options));
                if (!options.style.isTight()) {
                  inner.push((0, _buildCommon.makeSpan)(["mspace", "negativemediumspace"], [], options));
                }
          ...
          groupTypes.sqrt = function (group, options) {
            ...
            if (inner.height === 0 && inner.depth === 0) {
              ...
              inner.style.paddingLeft = img.surdWidth + "em"; // Overlay the image and the argument.
          ...
          groupTypes.rule = function (group, options) {
            ...
            var height = _units2["default"].calculateSize(group.value.height, options); // Style the rule to the right size
          ...
          groupTypes.accent = function (group, options) {
            ...
            if (!group.value.isStretchy) {
              ...
              accentBody = (0, _buildCommon.makeSpan)(["accent-body", accentClass], [accentBody]); // Shift the accent over by the skew. Note we shift by twice the skew
          ...
          var buildHTML = function buildHTML(tree, options) {
            ...
            var body = (0, _buildCommon.makeSpan)(["base"], expression, options); // Add struts, which ensure that the top of the HTML element falls at the
        ...
        38: [function (require, module, exports) {
          ...
          var makeInner = function makeInner(symbol, font, mode) {
            ...
            var inner = (0, _buildCommon.makeSpan)(["delimsizinginner", sizeClass], [(0, _buildCommon.makeSpan)([], [_buildCommon2["default"].makeSymbol(symbol, font, mode)])]); // Since this will be passed into `makeVList` in the end, wrap the element
  ...
  var katex$2 = unwrapExports(katex$1); // Copyright 2018 The Distill Template Authors
  //
  // Licensed under the Apache License, Version 2.0 (the "License");
  // you may not use this file except in compliance with the License.
  // You may obtain a copy of the License at
  ...
  function Mathematics(dom, data) {
    ...
    if (mathTags.length > 0) {
      needsCSS = true;
      console.warn("Prerendering ".concat(mathTags.length, " math tags..."));
      var _iterator6 = _createForOfIteratorHelper(mathTags),
        _step6;
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          var mathTag = _step6.value;
          var localOptions = {
  ...
  function Meta(dom, data) {
    ...
    var appendHead = function appendHead(html) {
      return appendHtml(head, html);
    };
    function meta(name, content, force) {
      if (content || force) appendHead("    <meta name=\"".concat(name, "\" content=\"").concat(escapeHtml_1(content), "\" >\n"));
    }
    appendHead("\n    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=Edge,chrome=1\">\n    <link rel=\"icon\" type=\"image/png\" href=\"data:image/png;base64,".concat(favicon, "\">\n    <link href=\"/rss.xml\" rel=\"alternate\" type=\"application/rss+xml\" title=\"Articles from Distill\">\n  "));
    if (data.title) {
      appendHead("\n    <title>".concat(escapeHtml_1(data.title), "</title>\n    "));
    }
    if (data.url) {
      appendHead("\n    <link rel=\"canonical\" href=\"".concat(data.url, "\">\n    "));
    }
    if (data.publishedDate) {
      appendHead("\n    <!--  https://schema.org/Article -->\n    <meta property=\"description\"       itemprop=\"description\"   content=\"".concat(escapeHtml_1(data.description), "\" />\n    <meta property=\"article:published\" itemprop=\"datePublished\" content=\"").concat(data.publishedISODateOnly, "\" />\n    <meta property=\"article:created\"   itemprop=\"dateCreated\"   content=\"").concat(data.publishedISODateOnly, "\" />\n    "));
    }
    if (data.updatedDate) {
      appendHead("\n    <meta property=\"article:modified\"  itemprop=\"dateModified\"  content=\"".concat(data.updatedDate.toISOString(), "\" />\n    "));
    }
    (data.authors || []).forEach(function (a) {
      appendHtml(head, "\n    <meta property=\"article:author\" content=\"".concat(escapeHtml_1(a.firstName), " ").concat(escapeHtml_1(a.lastName), "\" />"));
    });
    appendHead("\n    <!--  https://developers.facebook.com/docs/sharing/webmasters#markup -->\n    <meta property=\"og:type\" content=\"article\"/>\n    <meta property=\"og:title\" content=\"".concat(escapeHtml_1(data.title), "\"/>\n    <meta property=\"og:description\" content=\"").concat(escapeHtml_1(data.description), "\">\n    <meta property=\"og:url\" content=\"").concat(data.url, "\"/>\n    <meta property=\"og:image\" content=\"").concat(data.previewURL, "\"/>\n    <meta property=\"og:locale\" content=\"en_US\" />\n    <meta property=\"og:site_name\" content=\"Distill\" />\n  "));
    appendHead("\n    <!--  https://dev.twitter.com/cards/types/summary -->\n    <meta name=\"twitter:card\" content=\"summary_large_image\">\n    <meta name=\"twitter:title\" content=\"".concat(escapeHtml_1(data.title), "\">\n    <meta name=\"twitter:description\" content=\"").concat(escapeHtml_1(data.description), "\">\n    <meta name=\"twitter:url\" content=\"").concat(data.url, "\">\n    <meta name=\"twitter:image\" content=\"").concat(data.previewURL, "\">\n    <meta name=\"twitter:image:width\" content=\"560\">\n    <meta name=\"twitter:image:height\" content=\"295\">\n  ")); // if this is a proprer article, generate Google Scholar meta data
    if (data.doiSuffix) {
      ...
      meta('citation_firstpage', data.doiSuffix ? "e".concat(data.doiSuffix) : undefined);
      ...
      if (data.publishedDate) {
        meta('citation_online_date', "".concat(data.publishedYear, "/").concat(data.publishedMonthPadded, "/").concat(data.publishedDayPadded));
        meta('citation_publication_date', "".concat(data.publishedYear, "/").concat(data.publishedMonthPadded, "/").concat(data.publishedDayPadded));
      }
      (data.authors || []).forEach(function (a) {
        meta('citation_author', "".concat(a.lastName, ", ").concat(a.firstName));
  ...
  function citation_meta_content(ref) {
    var content = "citation_title=".concat(ref.title, ";");
    if (ref.author && ref.author !== '') {
      ref.author.split(' and ').forEach(function (name) {
        name = name.trim();
        var last, firsts;
        if (name.indexOf(',') != -1) {
        ...
        content += "citation_author=".concat(firsts, " ").concat(last, ";");
      });
    }
    if ('year' in ref) {
      content += "citation_publication_date=".concat(ref.year, ";");
    ...
    if (arxiv_id_search && arxiv_id_search[1]) {
      content += "citation_arxiv_id=".concat(arxiv_id_search[1], ";");
      return content; // arXiv is not considered a journal, so we don't need journal/volume/issue
    }
    if ('journal' in ref) {
      content += "citation_journal_title=".concat(escapeHtml_1(ref.journal), ";");
    }
    if ('volume' in ref) {
      content += "citation_volume=".concat(escapeHtml_1(ref.volume), ";");
    }
    if ('issue' in ref || 'number' in ref) {
      content += "citation_number=".concat(escapeHtml_1(ref.issue || ref.number), ";");
    }
    return content;
  }
  ...
  function renderTOC(element, headings) {
    ...
    try {
      for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
        ...
        if (isInTitle || isException) continue; // create TOC entry
  ...
  function Typeset(dom) {
    ...
    while (textNodes.nextNode()) {
      ...
      if (text && acceptNode(n)) {
        text = quotes(text);
        text = punctuation(text); // TODO: Add back support for ligatures once their uppercased versions don't hang Chrome search anymore
  ...
  function acceptNode(node) {
    ...
    return parent && parent.nodeName !== 'SCRIPT' && parent.nodeName !== 'STYLE' && parent.nodeName !== 'CODE' && parent.nodeName !== 'PRE' && parent.nodeName !== 'SPAN' && parent.nodeName !== 'D-HEADER' && parent.nodeName !== 'D-BYLINE' && parent.nodeName !== 'D-MATH' && parent.nodeName !== 'D-CODE' && parent.nodeName !== 'D-BIBLIOGRAPHY' && parent.nodeName !== 'D-FOOTER' && parent.nodeName !== 'D-APPENDIX' && parent.nodeName !== 'D-FRONTMATTER' && parent.nodeName !== 'D-TOC' && parent.nodeType !== 8 &&
    //comment nodes
    !isMath;
  } /*!
  ...
  function render(dom) {
    ...
    dom.head.insertBefore(loaderTag, dom.head.firstChild); // add loader event listener to add tempalrte back in
    var addTag = dom.createElement('script');
    addTag.innerHTML = addBackIn;
    dom.head.insertBefore(addTag, dom.head.firstChild); // create polyfill script tag
  ...
  function CitationList(dom, data) {
    ...
    if (citationListTag) {
      var entries = new Map(data.citations.map(function (citationKey) {
  ...
  var extractors = new Map([['ExtractFrontmatter', ExtractFrontmatter], ['ExtractBibliography', ExtractBibliography], ['ExtractCitations', ExtractCitations]]);
  var transforms = new Map([['HTML', HTML], ['makeStyleTag', makeStyleTag], ['OptionalComponents', OptionalComponents], ['TOC', TOC], ['Byline', Byline], ['Mathematics', Mathematics], ['Meta', Meta], ['Typeset', Typeset], ['Polyfills', render], ['CitationList', CitationList], ['Reorder', render$1] // keep last
  ]);
  var distillTransforms = new Map([['DistillHeader', DistillHeader], ['DistillAppendix', DistillAppendix], ['DistillFooter', DistillFooter]]); /* Exported functions */
  function render$2(dom, data) {
    ...
    var _iterator9 = _createForOfIteratorHelper(extractors.entries()),
      _step9;
    try {
      for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
        var _step9$value = _slicedToArray(_step9.value, 2),
          name = _step9$value[0],
          extract = _step9$value[1];
    ...
    var _iterator10 = _createForOfIteratorHelper(transforms.entries()),
      _step10;
    try {
      for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
        var _step10$value = _slicedToArray(_step10.value, 2),
          name = _step10$value[0],
          transform = _step10$value[1];
        if (verbose) console.warn('Running transform: ' + name); // console.warn('Running transform: ', transform);
    ...
    dom.body.setAttribute('distill-prerendered', ''); // the function calling us can now use the transformed dom and filled data object
  ...
  function distillify(dom, data) {
    ...
    var _iterator11 = _createForOfIteratorHelper(distillTransforms.entries()),
      _step11;
    try {
      for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
        var _step11$value = _slicedToArray(_step11.value, 2),
          name = _step11$value[0],
          transform = _step11$value[1];
